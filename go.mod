...
require (
	...
	github.com/openstack-k8s-operators/test-operator/api v0.6.1-0.20250704100241-311c53026033
...
replace github.com/rabbitmq/messaging-topology-operator => github.com/lmiccini/messaging-topology-operator v1.13.1-0.20250728122515-3e4003f543f7
