...
func (in *ContainerTemplate) DeepCopyInto(out *ContainerTemplate) {
	*out = *in
	...
	if in.EdpmPodmanExporterImage != nil {
		in, out := &in.EdpmPodmanExporterImage, &out.EdpmPodmanExporterImage
		*out = new(string)
		**out = **in
	}
	...
	if in.OpenstackNetworkExporterImage != nil {
		in, out := &in.OpenstackNetworkExporterImage, &out.OpenstackNetworkExporterImage
		*out = new(string)
		**out = **in
	}
	...
	if in.WatcherAPIImage != nil {
		in, out := &in.WatcherAPIImage, &out.WatcherAPIImage
		*out = new(string)
		**out = **in
	}
	if in.WatcherApplierImage != nil {
		in, out := &in.WatcherApplierImage, &out.WatcherApplierImage
		*out = new(string)
		**out = **in
	}
	if in.WatcherDecisionEngineImage != nil {
		in, out := &in.WatcherDecisionEngineImage, &out.WatcherDecisionEngineImage
		*out = new(string)
		**out = **in
	}
}
...
func (in *OpenStackVersionStatus) DeepCopyInto(out *OpenStackVersionStatus) {
	*out = *in
	...
	if in.AvailableServiceDefaults != nil {
		in, out := &in.AvailableServiceDefaults, &out.AvailableServiceDefaults
		*out = make(map[string]*ServiceDefaults, len(*in))
		for key, val := range *in {
			var outVal *ServiceDefaults
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
	...
	if in.TrackedCustomImages != nil {
		in, out := &in.TrackedCustomImages, &out.TrackedCustomImages
		*out = make(map[string]CustomContainerImages, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
func (in *RabbitmqSection) DeepCopyInto(out *RabbitmqSection) {
	*out = *in
	if in.Templates != nil {
		in, out := &in.Templates, &out.Templates
		*out = new(map[string]rabbitmqv1beta1.RabbitMqSpecCore)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]rabbitmqv1beta1.RabbitMqSpecCore, len(*in))
			for key, val := range *in {
				(*out)[key] = *val.DeepCopy()
			}
		}
...
func (in *ServiceDefaults) DeepCopyInto(out *ServiceDefaults) {
	*out = *in
	if in.GlanceWsgi != nil {
		in, out := &in.GlanceWsgi, &out.GlanceWsgi
		*out = new(string)
		**out = **in
	}
	if in.RabbitmqVersion != nil {
		in, out := &in.RabbitmqVersion, &out.RabbitmqVersion
		*out = new(string)
		**out = **in
	}
}
...
func (in *WatcherSection) DeepCopyInto(out *WatcherSection) {
	*out = *in
	if in.Template != nil {
		in, out := &in.Template, &out.Template
		*out = new(watcher_operatorapiv1beta1.WatcherSpecCore)
		(*in).DeepCopyInto(*out)
	}
	in.APIOverride.DeepCopyInto(&out.APIOverride)
}
