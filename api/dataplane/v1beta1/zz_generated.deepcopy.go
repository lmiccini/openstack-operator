...
import (
	...
	apiv1beta1 "github.com/openstack-k8s-operators/openstack-baremetal-operator/api/v1beta1"
	"k8s.io/api/core/v1"
...
func (in *OpenStackDataPlaneNodeSetSpec) DeepCopyInto(out *OpenStackDataPlaneNodeSetSpec) {
	*out = *in
	if in.BaremetalSetTemplate != nil {
		in, out := &in.BaremetalSetTemplate, &out.BaremetalSetTemplate
		*out = new(apiv1beta1.OpenStackBaremetalSetTemplateSpec)
		(*in).DeepCopyInto(*out)
	}
...
func (in *OpenStackDataPlaneNodeSetStatus) DeepCopyInto(out *OpenStackDataPlaneNodeSetStatus) {
	*out = *in
	...
	if in.ServiceCredentialStatus != nil {
		in, out := &in.ServiceCredentialStatus, &out.ServiceCredentialStatus
		*out = make(map[string]ServiceCredentialInfo, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceCredentialInfo) DeepCopyInto(out *ServiceCredentialInfo) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceCredentialInfo.
func (in *ServiceCredentialInfo) DeepCopy() *ServiceCredentialInfo {
	if in == nil {
		return nil
	}
	out := new(ServiceCredentialInfo)
	in.DeepCopyInto(out)
	return out
}
