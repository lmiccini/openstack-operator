...
require (
	...
	github.com/openstack-k8s-operators/designate-operator/api v0.6.1-0.20260417120052-a4d9e9923a7c
...
replace github.com/openstack-k8s-operators/infra-operator/apis => github.com/lmiccini/infra-operator/apis v0.0.0-20260424174038-ae1787c422cb
