...
// getOpenstackNetworkExporterImg handles backward compatibility for OpenStack Network Exporter image
func getOpenstackNetworkExporterImg(customImages corev1beta1.CustomContainerImages, defaults *corev1beta1.ContainerDefaults) *string {
	if customImages.OpenstackNetworkExporterImage != nil {
		return customImages.OpenstackNetworkExporterImage
	}
	//nolint:staticcheck // SA1019: Intentionally using deprecated field for backward compatibility
	if customImages.EdpmOpenstackNetworkExporterImage != nil {
		//nolint:staticcheck // SA1019: Intentionally using deprecated field for backward compatibility
		return customImages.EdpmOpenstackNetworkExporterImage
	}
	return defaults.OpenstackNetworkExporterImage
}
