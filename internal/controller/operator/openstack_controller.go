...
func (r *OpenStackReconciler) applyOperator(ctx context.Context, instance *operatorv1beta1.OpenStack) error {
	...
	for _, op := range operatorv1beta1.OperatorList {
		if img, ok := envRelatedOperatorImages[op.Name]; ok && img != nil {
			...
			// Default is false, flip to true as operators are converted
			// This code will be removed once all operators have METRICS_CERTS set to 'true'
			switch op.Name {
			case operatorv1beta1.BarbicanOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.CinderOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.DesignateOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.GlanceOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.HeatOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.HorizonOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
			...
			case operatorv1beta1.IronicOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
			...
			case operatorv1beta1.ManilaOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.MariaDBOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.NeutronOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.NovaOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.OctaviaOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
			...
			case operatorv1beta1.TelemetryOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.TestOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
					})
			case operatorv1beta1.WatcherOperatorName:
				serviceOp.Deployment.Manager.Env = append(serviceOp.Deployment.Manager.Env,
					corev1.EnvVar{
						Name:  "METRICS_CERTS",
						Value: "false",
