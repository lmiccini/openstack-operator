...
func (r *OpenStackDataPlaneNodeSetReconciler) updateNodeCoverageForService(
	...
	// Add newly covered nodes to the ConfigMap with retry on conflict
	err := retry.RetryOnConflict(retry.DefaultRetry, func() error {
		return deployment.AddUpdatedNodes(ctx, helper, instance.Name, instance.Namespace, serviceName, coveredNodes, ownerRefs)
	})
	if err != nil {
